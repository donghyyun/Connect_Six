...
public class JudgeDefence {
   ...
   public void defence() {
      ...
      if(userL.size() >= 2) {
  	    temp1 = userL.get(userL.size() - 1);
  	    //System.out.println("temp1 " + temp1);
  	    temp2 = userL.get(userL.size() - 2);
  	   // System.out.println("temp2 " + temp2);
  	 }
  	 else if (userL.size() == 1){
  		temp1 = userL.get(userL.size() - 1);
  		temp2 = userL.get(userL.size() - 1);
  		 //System.out.println("temp1 " + temp1);
  	 }
	 ...
	 index2 = temp1.y / 40 - 1;
      ...
      System.out.println(">>>>Defence ScoreL<<<<");
